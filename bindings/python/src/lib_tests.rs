...
fn test_download_task_methods_and_consumption_errors() {
    init_python();
    let downloader = PyDownloader::new(None, None, None, None, None, None, None, None, None).unwrap();
    let task = downloader
        .download(
...
fn test_py_downloader_with_log_level() {
    ...
    let d =
        PyDownloader::new(None, None, None, None, None, None, None, None, Some("debug".into()))
            .unwrap();
    drop(d);
    // Test invalid log_level
    let result =
        PyDownloader::new(None, None, None, None, None, None, None, None, Some("invalid".into()));
